...
function $61e2b7078adb18bc$var$PopoverInner({ state: state, isExiting: isExiting, UNSTABLE_portalContainer: UNSTABLE_portalContainer, clearContexts: clearContexts, ...props }) {
    ...
    (0, $4DQW2$react.useEffect)(()=>{
        if (isDialog && (props.trigger !== 'SubmenuTrigger' || (0, $4DQW2$reactariainteractions.getInteractionModality)() !== 'pointer') && ref.current && !(0, $4DQW2$reactariautils.isFocusWithin)(ref.current)) (0, $4DQW2$reactariainteractions.focusSafely)(ref.current);
    }, [
        isDialog,
        ref,
        props.trigger
