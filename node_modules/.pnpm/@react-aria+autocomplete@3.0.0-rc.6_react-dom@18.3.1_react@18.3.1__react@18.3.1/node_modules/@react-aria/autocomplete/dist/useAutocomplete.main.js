...
function $d43aec1bf2be84e8$export$1e40b3ca02d92d21(props, state) {
    ...
    let updateActiveDescendantEvent = (0, $4yz2I$reactariautils.useEffectEvent)((e)=>{
        ...
        let target = (0, $4yz2I$reactariautils.getEventTarget)(e);
    ...
    let onKeyDown = (e)=>{
        keyDownTarget.current = (0, $4yz2I$reactariautils.getEventTarget)(e);
    ...
    let onKeyUpCapture = (0, $4yz2I$reactariautils.useEffectEvent)((e)=>{
        ...
        if ((0, $4yz2I$reactariautils.getEventTarget)(e) === keyDownTarget.current) {
            var _collectionRef_current;
